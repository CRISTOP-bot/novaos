...
struct nova_boot_info { const char *bootloader_name, *bootloader_version; uint64_t kernel_physical_base, kernel_virtual_base, hhdm_offset; uint64_t memory_region_count; struct nova_memory_region memory_regions[NOVA_MAX_MEMORY_REGIONS]; };
